...
data_path = "../../data/processed/" + "data_withtexts2.dataset"

data = torch.load(data_path)

# print(f'training nodes: {data.y[data.train_mask]}')
# print(f'validation nodes: {data.y[data.val_mask]}')
